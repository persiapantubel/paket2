...
export const soalData: Soal[] = [
  {
    ...
    boxes: [
      { center: { t: 'segi8', f: false, dots: 1 }, tl: { t: 'segi3', f: true }, tr: { t: 'circle', f: false }, bl: { t: 'star', f: false }, br: { t: 'square', f: true } },
      { center: { t: 'segi8', f: false, dots: 1 }, tl: { t: 'star', f: true }, tr: { t: 'segi3', f: true }, bl: { t: 'square', f: true }, br: { t: 'circle', f: false } },
      { center: { t: 'segi8', f: false, dots: 1 }, tl: { t: 'square', f: false }, tr: { t: 'star', f: true }, bl: { t: 'circle', f: false }, br: { t: 'segi3', f: true } },
      { center: { t: 'segi8', f: false, dots: 1 }, tl: { t: 'circle', f: true }, tr: { t: 'square', f: false }, bl: { t: 'segi3', f: true }, br: { t: 'star', f: true } },
    ],
    options: [
